...
A.  Prior to the first State Quals tournament each year, all students that are entered or plan on entering multiple events in the State Quals series must submit a preference form indicating the order of their preferred events.
    1. Students that do not submit a preference form but qualify in multiple events will lose their ability to select a preferred event. The President may choose a preferred event for them at the President's discretion, or use an alternative method of determining the preferred event (eg. alphabetical).
