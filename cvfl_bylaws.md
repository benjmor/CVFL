...
## Section 7: State Qualification Preferences and Single-Entry

A.  Prior to the first State Quals tournament each year, all students that are entered or plan on entering multiple events in the State Quals series must submit a preference form indicating the order of their preferred events.
    1. Students that do not submit a preference form but qualify in multiple events will lose their ability to select a preferred event. The President may choose a preferred event for them at the President's discretion, or use an alternative method of determining the preferred event.
    1. CVFL officials are strongly encouraged to identify any double-entered students that have not submitted preference forms and ask them to submit preference forms prior to the start of the first state quals awards ceremony.
    1. Unlike NSDA rules, students **MAY** "leave their partner behind" (eg. a student that prefers OO over Duo, qualifies in both, and has a partner that does not qualify in another event, will drop their Duo spot for OO).
A.  The student's preference form is binding. However, it can be modified until the start of the first state quals awards ceremony.
A.  Prior to March 31st, in order to honor student preferences, drops/yields will "cascade". That is, if a student qualifies in a less-preferred event, and then earns a drop qualification in a more-preferred event, they must honor their initial preference and take the drop qualification in place of their less-preferred event. This will result in a vacancy in the student's original event, which is given to the event's next alternate (and so on).
A.  After March 31st, in order to reduce late changes, drops/yields will **not** cascade. That is, if a student earns a drop qualification in a more-preferred event, but already has any state qualification, they will not be eligible to take the more-preferred event. The drop qualification will be given to the next entry in the event that has no state qualification spot.
